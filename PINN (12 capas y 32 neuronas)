#CODIGO PINN (12 CAPAS Y 32 NUERONAS)
...
class PINN_Control_Cuantico:
    def __init__(self):
        # --- RED PSI (correcta) ---
        capas_psi = [2, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 2]
        self.net_psi = NLS_Net(capas_psi).to(device)

        # --- RED CONTROL (CORREGIDA) ---
        capas_control = [1, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 1]
